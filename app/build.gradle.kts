...
android {
    ...
    androidResources {
        // Only the languages the app is actually translated into.
        localeFilters += listOf("en", "kn")
...
dependencies {
    ...
    // App lock: the phone's fingerprint, face or screen lock, one API on Android 8 to 15.
